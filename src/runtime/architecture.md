...
|----------|-----------|--------------|
| Python | PyO3 + maturin | `icl-runtime` on [PyPI](https://pypi.org/project/icl-runtime/) |
| JavaScript | wasm-bindgen + wasm-pack | `icl-runtime` (local build; npm publish on `v*` tag) |
